export default function SubmitButton({type, name, disabled,processingLabel}) {
    return (<>
        <div>
            <button type={type} disabled={disabled} className="flex items-center justify-center w-full px-4 py-3 gap-2 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600" >
                {disabled && (
