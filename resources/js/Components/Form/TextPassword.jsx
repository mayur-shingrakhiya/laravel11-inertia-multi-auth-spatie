...
export default function TextPassword({type, name , placeholder,error,...props}) {
    ...
    return (<>
        ...
        <div  className="relative">
            <input name={name} type={`${!showPassword ? 'password' : 'text'}`}  placeholder={placeholder} {...props} 
            ...
            <svg onClick={togglePasswordVisibility}  x-show="!showPassword" className={`${showPassword ? 'hidden' : 'block'} fill-current`} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" >
            ...
            <svg onClick={togglePasswordVisibility} x-show="showPassword" className={`${showPassword ? 'block' : 'hidden'} fill-current`} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" >
