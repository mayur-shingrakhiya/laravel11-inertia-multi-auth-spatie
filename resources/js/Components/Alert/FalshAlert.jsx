export default function FalshAlert({flashMessage,flashType}) {
        let flashClass = flashType == 'success' ? 'success' : 'error';
    return (<>
        <div className={`rounded-xl border border-${flashClass}-500 bg-${flashClass}-50 p-4 dark:border-${flashClass}-500/30 dark:bg-${flashClass}-500/15 mb-2`}>
            <div className="flex items-start gap-3">
                <div className={`-mt-0.5 text-${flashClass}-500`}>
